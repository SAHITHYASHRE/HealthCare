...
public class Appointment implements Bookable {
    ...
    public Appointment(int appointment_id, int doctor_id, int patient_id,
                       LocalDate appointment_date, LocalTime time_slot, String status) {
    ...
    public LocalTime getTime_slot() { return time_slot; }
    public void setTime_slot(LocalTime time_slot) { this.time_slot = time_slot; }
    ...
    @Override
    public void book() {
        System.out.println("Appointment booked with ID: " + appointment_id);
    }
